class Music{
	...
	Music(){
		setTitle("찐"); setSinger("영탁"); genre = "트로트"; setPrice(3000);
	}
	...
	void display() {
		System.out.println("--------------------");
		System.out.println("ㅣ       title : " + getTitle()+"      ㅣ");
		System.out.println("ㅣ     singer : " + getSinger()+"    ㅣ");
		System.out.println("ㅣ     genre : " + genre+"   ㅣ");
		System.out.println("ㅣ     price : " + getPrice()+"  ㅣ");
		System.out.println("--------------------");
	}
	void display(int a) {
	...
	String show(){
		return "ㅣ  " +getTitle() +" "+ getSinger() +" "+ genre + " "+ getPrice() +"  ㅣ";
	}
